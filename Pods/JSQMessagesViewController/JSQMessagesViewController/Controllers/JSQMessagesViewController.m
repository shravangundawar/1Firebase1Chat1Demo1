...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.messageBubbleTopLabel.textColor = UIColor.redColor;
    cell.messageBubbleTopLabel.font = [UIFont systemFontOfSize:15];
    
    CGFloat bubbleBottomLabelInset = (avatarImageDataSource != nil) ? 50.0f : 15.0f;

    //Bottom Label (Display Name)
    if (isOutgoingMessage) {
        cell.cellBottomLabel.textInsets = UIEdgeInsetsMake(0.0f, 0.0f, 0.0f, bubbleBottomLabelInset);
    }
    else {
        cell.cellBottomLabel.textInsets = UIEdgeInsetsMake(0.0f, bubbleBottomLabelInset, 0.0f, 0.0f);
    }
    //Shravan End
